...
# ping Pong
# Language - Python
# Modules - pygame, sys, random, math,turtle
...
def boundary():
    ...
    pygame.draw.rect(display, blue, (width / 2 - margin / 2, 10, margin, l))
    pygame.draw.rect(display, yellow, (width / 2 - margin / 2, 60, margin, l))
    pygame.draw.rect(display, red, (width / 2 - margin / 2, 110, margin, l))
    pygame.draw.rect(display, white, (width / 2 - margin / 2, 160, margin, l))
    pygame.draw.rect(display, blue, (width / 2 - margin / 2, 210, margin, l))
    pygame.draw.rect(display, yellow, (width / 2 - margin / 2, 260, margin, l))
    pygame.draw.rect(display, red, (width / 2 - margin / 2, 310, margin, l))
